...
export default function LoadingScreen({ navigation }: LoadingScreenProps) {
  ...
  useEffect(() => {
    ...
    Animated.loop(
      Animated.sequence([
        ...
        Animated.timing(dotsAnim, { toValue: 0.4, duration: 700, useNativeDriver: true }),
      ])
    ).start();
  ...
  return (
    ...
    >
      <LinearGradient
        colors={["rgba(2,6,23,0.92)", "rgba(7,21,43,0.97)"]}
        style={styles.overlay}
      >
        <Animated.View style={[styles.content, { opacity: fadeAnim }]}>

          {/* HANDSHAKE */}
          <View style={{ width: isMobile ? 220 : 320, height: isMobile ? 220 : 320, justifyContent: "center", alignItems: "center" }}>
            <LottieView
          ...
          {/* TITLE */}
          <Text style={[styles.title, { fontSize: isMobile ? 34 : 52 }]}>
            Network Dev
          </Text>
